public class DucatiPanigale1199 extends Motor implements interfaceMotoren{
    private String kleur;

    public DucatiPanigale1199(String merk, String model, int bouwjaar, int kilometerstand, int prijs, int hoeveelheidCilinders, String kleur) {
